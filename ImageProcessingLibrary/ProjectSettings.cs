...
namespace ImageProcessingLibrary
{
    public class ProjectSettings
    {
        ...
        public static string ConnectorsDefaultFolder => Path.Combine(DefaultFolder, "Connectors");
        public static string AccessoriesDefaultFolder => Path.Combine(DefaultFolder, "Accessories");
